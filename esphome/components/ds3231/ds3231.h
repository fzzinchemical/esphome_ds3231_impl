...
class DS3231Component : public time::RealTimeClock, public i2c::I2CDevice {
 ...
 protected:
  ...
  uint8_t raw_rtc[sizeof(rtc_)];
  uint8_t raw_alarm1[sizeof(Alarm::alarm1)];
  uint8_t raw_alarm2[sizeof(Alarm::alarm2)];
  uint8_t raw_special[sizeof(special)];
  uint8_t raw_temperature[sizeof(temperature)];
};
